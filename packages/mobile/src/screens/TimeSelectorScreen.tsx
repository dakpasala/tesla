        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.timeModeContainer}>
            <TouchableOpacity
              style={[
                ...
                timeMode === 'now' && styles.timeModeButtonActive,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.timeModeButton,
                timeMode === 'leave' && styles.timeModeButtonActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.timeModeText,
                  timeMode === 'leave' && styles.timeModeTextActive,
                ]}
              >
                Leave
              </Text>
          ...
          {timeMode !== 'now' && (
            <View style={styles.pickerContainer}>
              {Platform.OS === 'ios' ? (
                // iOS: inline spinner works correctly
                <DateTimePicker
                  value={selectedDate}
                  mode="datetime"
                  display="spinner"
                ...
                // Android: picker shows as dialog, so show tappable display
                <>
                  <TouchableOpacity
                    style={styles.androidPickerDisplay}
